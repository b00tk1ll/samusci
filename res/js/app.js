...
(function(){
  ...
  var config = {
    apiKey: "AIzaSyCxAoOfq999-Htr1SQnAvqsNA7nmF1I9x0",
    authDomain: "samusci-d0e8e.firebaseapp.com",
    databaseURL: "https://samusci-d0e8e.firebaseio.com",
    projectId: "samusci-d0e8e",
    storageBucket: "samusci-d0e8e.appspot.com",
    messagingSenderId: "158358017016"
  };
